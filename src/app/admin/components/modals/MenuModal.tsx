...
const MenuModal: React.FC<MenuModalProps> = ({
  ...
  }, [selectedSize, selectedAddons, quantity, item, addonData]);
  ...
  const footer = !isOrderable ? (
    ...
    <div className="flex justify-between items-center gap-4 w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="w-8 font-bold text-[#776B5D] text-lg text-center">
          {quantity}
        </span>
        <Button
          variant="ghost"
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        <p className="text-[#776B5D] text-sm capitalize">
          {item.type.replace("-", " ")}
        </p>
              ...
              {addonData.map((addon) => (
                ...
                >
                  <div className="flex flex-col items-start">
                    ...
                    {addon.description && (
                      <span className="opacity-75 mt-1 text-xs">
                        {addon.description}
                      </span>
                    )}
                  </div>
